export default function Back({
  ...
  return (
    ...
    >
      ...
      <button className="absolute bottom-3 left-12 text-white bg-gray-800 focus:ring-4 focus:ring-gray-900 font-medium rounded-lg text-sm px-5 py-3 mt-2 mb-2  min-w-[250px] hover:border-green-500  border-4">
        Make an appointment
      </button>
    </div>
  );
